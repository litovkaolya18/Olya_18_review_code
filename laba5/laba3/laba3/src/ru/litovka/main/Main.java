                ...
                case 1: {
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        while (true) {
                            ...
                            type = validator.getNumInput("Ваш выбор: ");
                        ...
                        if (type == 1) {
                            ...
                            // ЧАСЫ
                            while (true) {
                                h = validator.getNumInput("Введите часы (0–23): ");
                                if (h >= 0 && h <= 23) break;
                                System.out.println("Ошибка: часы должны быть в диапазоне 0–23.");
                            }

                            // МИНУТЫ
                            while (true) {
                                m = validator.getNumInput("Введите минуты (0–59): ");
                                if (m >= 0 && m <= 59) break;
                                System.out.println("Ошибка: минуты должны быть в диапазоне 0–59.");
                            }

                            // СЕКУНДЫ
                            while (true) {
                                s = validator.getNumInput("Введите секунды (0–59): ");
                                if (s >= 0 && s <= 59) break;
                                System.out.println("Ошибка: секунды должны быть в диапазоне 0–59.");
                            }

                            userTime = new Time(h, m, s);
                        }

                        allTimes.append(i + 1).append(". ").append(userTime).append("\n");
                    }
