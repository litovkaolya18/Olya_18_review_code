...
public class Department {
    ...
    //FIX_ME: магическое число 100 — лучше вынести в константу
    //для понимания максимального числа сотрудников
    ...
    public String getAllEmployeesList() {
        ...
        //FIX_ME: конкатенация строк в цикле через '+' создаёт много временных объектов.
